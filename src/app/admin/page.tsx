  ...
  const handleSeedDatabase = async () => {
    ...
    try {
      ...
      if (dbMesas && dbMesas.length > 0) {
        const m1 = dbMesas.find(m => m.numero === 1)?.id || dbMesas[0].id;
        const m2 = dbMesas.find(m => m.numero === 2)?.id || dbMesas[0].id;
        const m3 = dbMesas.find(m => m.numero === 3)?.id || dbMesas[0].id;
        const m4 = dbMesas.find(m => m.numero === 4)?.id || dbMesas[0].id;
        const m5 = dbMesas.find(m => m.numero === 5)?.id || dbMesas[0].id;
        const m6 = dbMesas.find(m => m.numero === 6)?.id || dbMesas[0].id;
        ...
        const sampleAsistentes = [
          ...
          { id: 'ba9902a4-e54e-47b5-9c49-fa0c91a12b6b', nombre: 'Rosa Linda Velásquez González', cedula: 'V-5.279.743', telefono: '0424-3288729', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 2B', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m1, asistio: false },
          { id: '7c25dc96-0f54-438b-8795-9f161ccbe323', nombre: 'Beccy Partida', cedula: 'V8744079', telefono: '0412-1482113', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II TORRE 2D', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m1, asistio: false },
          { id: 'b4c2d98d-08c1-4b60-9534-0d7bafab55a5', nombre: 'MARIA GIL', cedula: 'V-7249693', telefono: '0424-3658402', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 1D', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m1, asistio: false },
          { id: '617257c0-5ecd-47ca-8c35-11137eb36f70', nombre: 'Reina roa', cedula: 'V10897383', telefono: '0424-3298133', condominio: 'Conjunto residencial el lago II Edificio 6B', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m1, asistio: false },
          
          { id: '3b3ec3c5-1d1d-4417-acc9-f186e336a200', nombre: 'José Luis Tovar', cedula: 'V-3.398.281', telefono: '0424-3447615', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II Edificio 2A', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m2, asistio: false },
          { id: '8a029496-c600-4602-b2af-2a1f0d4df63f', nombre: 'Stivaly Fattore', cedula: 'V20451000', telefono: '0424-3119473', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 8C', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m2, asistio: false },
          { id: '9ea8829b-de97-4a66-8496-2d386a9858b9', nombre: 'Mercedes Elena Rodrigu', cedula: '8740037', telefono: '0412-4307380', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 3F', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m2, asistio: false },
          { id: 'e5f69a69-4225-4895-b897-d80c3a643794', nombre: 'Magalis Garcia', cedula: '4555713', telefono: '0412-3554165', condominio: 'Conjunto Residencial El Lago II Edificio 4F', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m2, asistio: false },
          
          { id: '223b4628-62d4-4c14-8e7f-ab0f5ccfff05', nombre: 'Luis Arenas', cedula: 'V9621800', telefono: '0426-5145220', condominio: 'Conjunto Residencial El Lago II Edificio 4B', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m3, asistio: false },
          { id: 'e2d5feb1-d635-4b7b-824f-8a02689b1fad', nombre: 'Nacari Torres', cedula: '12140240', telefono: '0412-4569851', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 1F', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m3, asistio: false },
          { id: 'cf82625b-27dc-41d2-bdc3-19f08b4450bf', nombre: 'Susana Pérez', cedula: 'V-19277791', telefono: '0412-5334747', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 2E', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m3, asistio: false },
          { id: '1dff0fa3-f41d-40d7-8823-34dac0dc0fe6', nombre: 'María Ramos', cedula: '10694505', telefono: '0414-3532884', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 9E', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m3, asistio: false },
          ...
          { id: 'b68d0777-e47c-460e-81cc-ec2e7dfead88', nombre: 'Damarys González', cedula: '15286066', telefono: '0412-8920536', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 6D', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m5, asistio: false },
          ...
          { id: '8c8a2f7b-7872-489f-bc69-5a61e9054ce2', nombre: 'Roxana Gómez', cedula: 'V14354296', telefono: '0412-4871616', condominio: 'CONJUNTO RESIDENCIAL EL LAGO II EDIFICIO 5E', municipio: 'Girardot', estado: 'Aragua', parroquia: 'José Casanova Godoy', mesa_preasignada_id: m5, asistio: false },
